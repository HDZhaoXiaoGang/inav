...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM4,  CH3, PB8,  TIM_USE_OUTPUT_AUTO, 0, 0), // S4  D(1,7,2)
    DEF_TIM(TIM4,  CH4, PB9,  TIM_USE_OUTPUT_AUTO, 0, 0), // S5  D(1,3,2)
    DEF_TIM(TIM2,  CH1, PA0,  TIM_USE_OUTPUT_AUTO, 0, 0), // S6  D(1,2,3)
    // DEF_TIM(TIM2,  CH2, PA1,  TIM_USE_OUTPUT_AUTO, 0, 0), // S7  D(1,3,3) - 已禁用，避免与PB3冲突
